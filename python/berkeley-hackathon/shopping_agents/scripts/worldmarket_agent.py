...
from core.web_search.worldmarket import worldmarket_crawler_with_selenium
            ...
            if dora_event['id'] == 'worldmarket_search':
                ...
                for web_search_text in web_search_tasks:
                    if time.time() - t1 > self.timeout:
                        break
                    try:
                        html_context = worldmarket_crawler_with_selenium(search_term=web_search_text)
                        ...
                        print(e)
                        continue
                print(" worldmarket_result  :  ",all_results)
                send_output("worldmarket_shopping_result", pa.array([create_agent_output(step_name='worldmarket_shopping_result',
