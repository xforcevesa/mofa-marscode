...
from core.web_search.minted import minted_crawler_with_selenium
            ...
            if dora_event['id'] == 'minted_search':
                ...
                for web_search_text in web_search_tasks:
                    if time.time() - t1 > self.timeout:
                        break
                    try:
                        html_context = minted_crawler_with_selenium(search_term=web_search_text)
                        ...
                        print(e)
                        continue
                print(" minted_result  :  ",all_results)
                send_output("minted_shopping_result", pa.array([create_agent_output(step_name='minted_shopping_result',
