...
#     Seller_Store_Link: Optional[str] = Field( description="URL to the seller's store or profile")
#
#
...
#     Product_Link: str = Field(description="Direct URL to purchase the product")
...
#     Images: List[str] = Field(description="URLs to product images")
...
#     User_Review:bool = Field(description="Determine if the user is satisfied with the solution; if satisfied, return true. Otherwise, return false.")
