...
5. In a separate terminal, use `cd /mofa_berkeley_hackathon/python/MoFA_marscode/ui && streamlit run socket_client.py` to open the page. Make sure that port 12345 is not in use. If it is, use `lsof -i :12345` to find the process ID and kill it with `kill -9`.
